			...
			<div class="container" style="width: 800px; margin-top: 200px">
				...
				<div class="card text-center border-light mb-3a">
					<div class="card-block">
						<h4 class="card-title" style="margin-top: 10px"><strong>Add attributes to recipe</strong></h4>
						<br>
						<c:if test="${! empty addedRecipe }">
							...
							<form action="/Coolinarika/users/addPicture" method="post">
								<table style="margin-left: 50px">
									<tr>
										<td><input type="text" name = "picture" id="form1" class="form-control" placeholder="Picture path..." style="width: 300px; margin-left: 100px"></td>
										<td><input type="submit"
											value="ADD"
											class="btn btn-outline-black btn-rounded btn-sm waves-effect waves-dark"></td>
									</tr>
							...
							<br>
							<c:if test = "${! empty pic }">
								<p>Just added a new picture path!</p>
							</c:if>
							<br>
						</c:if>
					</div>
